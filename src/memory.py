        ...
        for msg in chat_history:
            ...
            if msg.get("role") == "assistant":
                ...
                for line in lines:
                    ...
                    elif re.search(r"memory|fact|note|remember", line, re.I) or re.match(r"^={3,}|-{3,}|_{3,}", line):
                        pass
        ...
        for memory in memories:
            ...
            is_identity = any(
                [
                    ...
                    any(
                        word in memory_text
                        for word in ["name is", "i'm", "i am", "called", "my name", "named", "call me"]
                    ),
                ]
            )
            if is_identity:
        ...
        for memory in other_memories:
            ...
            if query_type == "contact":
                ...
                has_contact_info = any(
                    word in memory_text
                    for word in ["@gmail.com", "@", ".com", "phone", "number", "address", "http", "www", "tel:"]
                )
                if has_contact_info:
                ...
                has_preference = any(
                    word in memory_text
                    for word in ["like", "love", "hate", "dislike", "prefer", "favorite", "enjoy", "interested"]
                )
                if has_preference:
                ...
                has_task = any(
                    word in memory_text
                    for word in ["todo", "task", "remind", "meeting", "appointment", "schedule", "deadline", "need to"]
                )
                if has_task:
