...
from .diagram_tools import RenderDiagramTool
...
from .filesystem_tools import EditFileTool, GetWorkspaceTool, GlobTool, GrepTool, LsTool, ReadFileTool, WriteFileTool
from .model_interaction_tools import AskTeacherTool, ChatWithModelTool, ListModelsTool
from .session_tools import CreateSessionTool, ListSessionsTool, ManageSessionTool, SendToSessionTool
...
TOOL_HANDLERS = {
    ...
    "render_diagram": RenderDiagramTool().execute,
}
