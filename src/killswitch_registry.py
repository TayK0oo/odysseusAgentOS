...
_SWITCHES: list[dict[str, Any]] = [
    ...
    {"name": "Durable execution", "env_var": "ODYSSEUS_DURABLE_EXEC",
     "default": "on", "category": "Orchestration", "timing": "runtime",
     "desc": "Execution durable Custom SQLite: workflows, retry, saga, approbation humaine. Coeur stable ON par defaut.",
     "source": "src/durable_execution/engine.py:30"},
    {"name": "Memory provenance", "env_var": "ODYSSEUS_MEMORY_PROVENANCE",
     "default": "on", "category": "Governance/Memory", "timing": "runtime",
     "desc": "Memoire avec provenance: taxonomie MD, tags [stated]/[observed]/[inferred], versionnage hash. Coeur stable ON par defaut.",
     "source": "src/memory_provenance/operations.py"},
    {"name": "Preferences", "env_var": "ODYSSEUS_PREFERENCES",
     "default": "on", "category": "Governance/Memory", "timing": "runtime",
     "desc": "Preferences utilisateur: resolution ordonnee, guardrails comportementaux. Coeur stable ON par defaut.",
     "source": "src/preferences/engine.py"},
    {"name": "Visual output", "env_var": "ODYSSEUS_VISUAL_OUTPUT",
     "default": "on", "category": "Governance/Memory", "timing": "runtime",
     "desc": "Sortie visuelle: arbre decision, HTML/SVG inline, modules design, Kroki. Coeur stable ON par defaut.",
     "source": "src/visual_output/router.py"},
    {"name": "Data classification", "env_var": "ODYSSEUS_DATA_CLASSIFICATION",
     "default": "on", "category": "Governance/Memory", "timing": "runtime",
     "desc": "Classification donnees: 5 niveaux retention, droit a l'oubli. Coeur stable ON par defaut.",
     "source": "src/classification/levels.py"},
    {"name": "Content security", "env_var": "ODYSSEUS_CONTENT_SECURITY",
     "default": "on", "category": "Governance/Memory", "timing": "runtime",
     "desc": "Securite contenus: injection guard, output filter, rappels systeme. Coeur stable ON par defaut.",
     "source": "src/content_security/injection.py"},
    {"name": "Tool discovery", "env_var": "ODYSSEUS_TOOL_DISCOVERY",
     "default": "off", "category": "Orchestration", "timing": "runtime",
     "desc": "Decouverte outils: tool_search, registre MCP, suggest_connectors. Experimental OFF par defaut.",
     "source": "src/tool_discovery/search.py"},
    ...
    {"name": "LangFuse", "env_var": "ODYSSEUS_LANGFUSE",
     "default": "off", "category": "Governance/Memory", "timing": "runtime",
     "desc": "LLM tracing & observability dashboard (self-hosted).",
     "source": "services/observability/langfuse_tracer.py:24"},
    ...
    {"name": "LangGraph loop", "env_var": "ODYSSEUS_LANGGRAPH",
     "default": "off", "category": "Orchestration", "timing": "runtime",
     "desc": "StateGraph 7-nœuds (remplace stream_agent_loop).",
     "source": "src/orchestrator/langgraph_loop.py:33"},
    {"name": "LangGraph interrupt", "env_var": "ODYSSEUS_LANGGRAPH_INTERRUPT",
     "default": "on", "category": "Orchestration", "timing": "runtime",
     "desc": "Interrupt before BUILD when risk==DESTRUCTIVE.",
     "source": "src/orchestrator/langgraph_loop.py:441"},
