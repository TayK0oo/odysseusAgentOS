...
if getattr(sys, "frozen", False):
    ...
    def show_splash_instantly():
        ...
        try:
            ...
            tk.Label(splash_root, text="⛵ Odysseus", font=("Segoe UI", 22, "bold"), bg="#1a1c23", fg="#e06c75").pack(
                pady=(22, 2)
            )
            tk.Label(
                splash_root, text="Launching background services...", font=("Segoe UI", 10), bg="#1a1c23", fg="#d1d4e0"
            ).pack(pady=2)
            tk.Label(
                splash_root,
