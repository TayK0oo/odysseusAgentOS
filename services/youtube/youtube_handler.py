...
async def extract_transcript_async(url: str, video_id: str, max_retries: int = 3) -> dict[str, Any]:
    """
...
def format_transcript_for_context(transcript_data: dict[str, Any], url: str, title: str = "", channel: str = "") -> str:
...
async def fetch_youtube_comments(video_id: str, max_comments: int = 25, timeout: int = 30) -> dict[str, Any]:
    ...
    try:
        ...
        return {"success": True, "comments": comments, "count": len(comments), "title": title, "channel": channel}
