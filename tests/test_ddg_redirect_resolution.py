...
def test_resolves_genuine_ddg_redirects():
    ...
    assert _resolve_ddg_redirect("//duckduckgo.com/l/?uddg=https%3A%2F%2Fexample.com") == "https://example.com"
    # relative href -> resolved against html.duckduckgo.com (a real DDG subdomain)
    assert _resolve_ddg_redirect("/l/?uddg=https%3A%2F%2Fexample.com") == "https://example.com"
