...
from launcher import NullWriter, create_tray_image, on_exit, on_open_browser, open_browser
...
def test_open_browser():
    with mock.patch("webbrowser.open") as mock_open, mock.patch("time.sleep") as mock_sleep:
