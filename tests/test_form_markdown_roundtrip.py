...
def test_asterisk_label_value_survives_export_roundtrip():
    fields = [
        {"name": "email", "label": "Email Address *", "type": "text", "value": "me@x.com", "page": 1},
        {"name": "state", "label": "State *", "type": "choice", "options": ["CA", "NY"], "value": "NY", "page": 1},
        {"name": "sign", "label": "Signature *", "type": "signature", "value": "signature:s1", "page": 1},
    ]
...
def test_plain_labels_and_colon_values_unaffected():
    fields = [
        {"name": "name", "label": "Full Name", "type": "text", "value": "Alice", "page": 1},
        {"name": "time", "label": "Start Time", "type": "text", "value": "9:00 sharp", "page": 1},
    ]
    md = render_form_as_markdown(fields, "u", "F")
    vals = parse_markdown_to_values(md)
