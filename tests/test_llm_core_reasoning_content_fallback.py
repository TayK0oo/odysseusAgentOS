...
def test_llm_call_async_returns_reasoning_content_when_content_empty(monkeypatch):
    class _FakeAsyncClient:
        async def post(self, *a, **kw):
            ...
            return httpx.Response(200, request=req, json=_openai_msg("", "async reasoning text"))
...
def test_stream_agent_reasoning_not_duplicated_as_normal_delta():
    ...
    assert chunk is None, f"reasoning text was re-emitted as a normal delta chunk: {chunk!r}"
