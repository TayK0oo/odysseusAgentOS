...
def test_prompt_cache_busted_after_disconnect_same_tool_count():
    ...
    _inject_tools(
        mgr,
        "srv_a",
        [{"name": "tool_alpha", "description": "Alpha tool", "inputSchema": {"type": "object", "properties": {}}}],
    )
    ...
    _inject_tools(
        mgr,
        "srv_b",
        [{"name": "tool_beta", "description": "Beta tool", "inputSchema": {"type": "object", "properties": {}}}],
    )
    mgr._generation += 1  # simulated successful connect
    ...
    assert "tool_beta" in desc_b, "Cache was not invalidated: got stale description after reconnect"
