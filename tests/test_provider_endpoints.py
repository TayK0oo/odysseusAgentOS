...
PROVIDER_CASES = [
    ...
    ("xai", "https://api.x.ai/v1", "https://api.x.ai/v1/chat/completions", "https://api.x.ai/v1/models"),
    (
        "deepseek",
    ...
    ("ollama_cloud", "https://ollama.com", "https://ollama.com/api/chat", "https://ollama.com/api/tags"),
]
